...
class TrabajosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabajo" do
    assert_difference("Trabajo.count") do
      post trabajos_url, params: { trabajo: { contenido: @trabajo.contenido, titulo: @trabajo.titulo } }
    end
  ...
  test "should update trabajo" do
    patch trabajo_url(@trabajo), params: { trabajo: { contenido: @trabajo.contenido, titulo: @trabajo.titulo } }
